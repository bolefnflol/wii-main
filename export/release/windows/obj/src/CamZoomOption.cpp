...
HX_DEFINE_STACK_FRAME(_hx_pos_7858b555654f959a_638_new,"CamZoomOption","new",0xae7b5429,"CamZoomOption.new","Options.hx",638,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_643_press,"CamZoomOption","press",0xf26f1b8c,"CamZoomOption.press","Options.hx",643,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_651_updateDisplay,"CamZoomOption","updateDisplay",0x0b240842,"CamZoomOption.updateDisplay","Options.hx",651,0x9d9a0240)

void CamZoomOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_638_new)
HXLINE( 639)		super::__construct();
HXLINE( 640)		this->description = desc;
            	}
...
bool CamZoomOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_643_press)
HXLINE( 644)		::flixel::FlxG_obj::save->data->__SetField(HX_("camzoom",a2,ca,10,f1),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camzoom",a2,ca,10,f1),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 645)		this->display = this->updateDisplay();
HXLINE( 646)		return true;
            	}


::String CamZoomOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_651_updateDisplay)
HXDLIN( 651)		::String _hx_tmp;
HXDLIN( 651)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camzoom",a2,ca,10,f1),::hx::paccDynamic)) ))) {
HXDLIN( 651)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 651)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 651)		return (HX_("Camera Zoom ",f2,a5,9b,43) + _hx_tmp);
            	}
