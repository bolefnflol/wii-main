...
HXLINE(  95)		{
HXLINE(  95)			 ::flixel::text::FlxText _this = this->infoText;
HXDLIN(  95)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN(  95)			if (::hx::IsNull( axes )) {
HXLINE(  95)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
...
HXDLIN( 125)			if (_this->keyManager->checkStatusUnsafe(38,_this->status)) {
...
HXDLIN( 131)			if (_this1->keyManager->checkStatusUnsafe(40,_this1->status)) {
...
HXDLIN( 137)			if (_this2->keyManager->checkStatusUnsafe(9,_this2->status)) {
...
HXDLIN( 144)			if (_this3->keyManager->checkStatusUnsafe(13,_this3->status)) {
...
HXDLIN( 148)				if (_this->keyManager->checkStatusUnsafe(27,_this->status)) {
...
HXDLIN( 151)					if (_this->keyManager->checkStatusUnsafe(8,_this->status)) {
...
HXDLIN( 192)				if (_this->keyManager->checkStatusUnsafe(27,_this->status)) {
...
HXDLIN( 217)				if (_this->keyManager->checkStatusUnsafe(27,_this->status)) {
...
HXDLIN( 222)					if (_this->keyManager->checkStatusUnsafe(13,_this->status)) {
...
HXLINE( 274)		{
HXLINE( 274)			 ::flixel::text::FlxText _this = this->keyTextDisplay;
HXDLIN( 274)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN( 274)			bool _hx_tmp;
HXDLIN( 274)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXLINE( 274)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 274)				_this->set_x(((( (Float)(_hx_tmp) ) - _this->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE( 274)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 274)				_this->set_y(((( (Float)(_hx_tmp) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
            	}
