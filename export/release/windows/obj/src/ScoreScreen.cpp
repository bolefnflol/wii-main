...
HX_DEFINE_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_342_new,"ScoreScreen","new",0x96db9c30,"ScoreScreen.new","Options.hx",342,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_348_press,"ScoreScreen","press",0xe976b353,"ScoreScreen.press","Options.hx",348,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_356_updateDisplay,"ScoreScreen","updateDisplay",0x3fc33f09,"ScoreScreen.updateDisplay","Options.hx",356,0x9d9a0240)

void ScoreScreen_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_342_new)
HXLINE( 343)		super::__construct();
HXLINE( 344)		this->description = desc;
            	}
...
bool ScoreScreen_obj::press(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_348_press)
HXLINE( 349)		::flixel::FlxG_obj::save->data->__SetField(HX_("scoreScreen",5e,6c,c3,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 350)		this->display = this->updateDisplay();
HXLINE( 351)		return true;
            	}


::String ScoreScreen_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_356_updateDisplay)
HXDLIN( 356)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )) {
HXDLIN( 356)			return HX_("Show Score Screen",9d,cf,bf,e6);
            		}
            		else {
HXDLIN( 356)			return HX_("No Score Screen",d9,d1,47,3c);
            		}
