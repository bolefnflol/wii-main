...
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",31,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_35_rename,"sys.FileSystem","rename",0x3aa2fb40,"sys.FileSystem.rename","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",35,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",38,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_64_absolutePath,"sys.FileSystem","absolutePath",0x5973f4fe,"sys.FileSystem.absolutePath","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",64,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",75,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",78,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",93,0xa643da29)
HX_LOCAL_STACK_FRAME(_hx_pos_3192d487c4a385d6_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/FileSystem.hx",101,0xa643da29)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_31_exists)
...
void FileSystem_obj::rename(::String path,::String newPath){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_35_rename)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FileSystem_obj,rename,(void))
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
::String FileSystem_obj::absolutePath(::String relPath){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_64_absolutePath)
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_93_deleteFile)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_3192d487c4a385d6_101_readDirectory)
