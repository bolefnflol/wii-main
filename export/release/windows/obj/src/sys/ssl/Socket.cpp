...
HX_DEFINE_STACK_FRAME(_hx_pos_e21235cc48b8af90_119_new,"sys.ssl.Socket","new",0xb0189de8,"sys.ssl.Socket.new","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",119,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_9eb6d100aaca0bae_295___init__,"::sys::ssl::Socket_obj","__init__",0xb5703314,"::sys::ssl::Socket_obj.__init__","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",295,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_138_init,"sys.ssl.Socket","init",0x622a4488,"sys.ssl.Socket.init","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",138,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_152_connect,"sys.ssl.Socket","connect",0x6aae6d72,"sys.ssl.Socket.connect","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",152,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_174_handshake,"sys.ssl.Socket","handshake",0x5679847f,"sys.ssl.Socket.handshake","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",174,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_213_close,"sys.ssl.Socket","close",0x0d1c5740,"sys.ssl.Socket.close","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",213,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_260_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",260,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_267_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",267,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_e21235cc48b8af90_120_boot,"sys.ssl.Socket","boot",0x5d8a8daa,"sys.ssl.Socket.boot","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",120,0x80f946be)
namespace sys{
namespace ssl{

void Socket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_119_new)
...
void Socket_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_9eb6d100aaca0bae_295___init__)
HXDLIN( 295)		_hx_ssl_init();
            	}


void Socket_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_e21235cc48b8af90_138_init)
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_152_connect)
HXDLIN( 152)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void Socket_obj::handshake(){
            	HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_174_handshake)
...
void Socket_obj::close(){
            	HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_213_close)
...
HXLINE( 225)		output->close();
 ...
 ::Dynamic Socket_obj::buildSSLConfig(bool server){
            	HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_260_buildSSLConfig)
...
HXLINE( 266)		if (::hx::IsNotNull( this->altSNIContexts )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::sys::ssl::Socket,_gthis) HXARGC(1)
            			 ::Dynamic _hx_run( ::Dynamic servername){
            				HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_267_buildSSLConfig)
...
{
{
            	HX_STACKFRAME(&_hx_pos_e21235cc48b8af90_120_boot)
