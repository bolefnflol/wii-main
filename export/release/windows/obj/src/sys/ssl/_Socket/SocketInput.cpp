...
HX_DEFINE_STACK_FRAME(_hx_pos_bd9cc1d7ca43861b_36_new,"sys.ssl._Socket.SocketInput","new",0x0d9c972a,"sys.ssl._Socket.SocketInput.new","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",36,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_bd9cc1d7ca43861b_40_readByte,"sys.ssl._Socket.SocketInput","readByte",0xa45b5674,"sys.ssl._Socket.SocketInput.readByte","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",40,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_bd9cc1d7ca43861b_53_readBytes,"sys.ssl._Socket.SocketInput","readBytes",0x2b904f7f,"sys.ssl._Socket.SocketInput.readBytes","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",53,0x80f946be)
HX_LOCAL_STACK_FRAME(_hx_pos_bd9cc1d7ca43861b_71_close,"sys.ssl._Socket.SocketInput","close",0xce82a502,"sys.ssl._Socket.SocketInput.close","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",71,0x80f946be)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketInput_obj::__construct( ::sys::ssl::Socket s){
            	HX_STACKFRAME(&_hx_pos_bd9cc1d7ca43861b_36_new)
...
int SocketInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_bd9cc1d7ca43861b_40_readByte)
HXDLIN(  40)		try {
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_bd9cc1d7ca43861b_53_readBytes)
HXLINE(  54)		int r;
...
void SocketInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_bd9cc1d7ca43861b_71_close)
