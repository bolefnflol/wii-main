...
HX_LOCAL_STACK_FRAME(_hx_pos_3c7cff83ba115915_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/File.hx",30,0xfe83fc43)
HX_LOCAL_STACK_FRAME(_hx_pos_3c7cff83ba115915_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/File.hx",33,0xfe83fc43)
HX_LOCAL_STACK_FRAME(_hx_pos_3c7cff83ba115915_38_saveContent,"sys.io.File","saveContent",0xa5557651,"sys.io.File.saveContent","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/File.hx",38,0xfe83fc43)
HX_LOCAL_STACK_FRAME(_hx_pos_3c7cff83ba115915_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/File.hx",44,0xfe83fc43)
HX_LOCAL_STACK_FRAME(_hx_pos_3c7cff83ba115915_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/File.hx",51,0xfe83fc43)
HX_LOCAL_STACK_FRAME(_hx_pos_3c7cff83ba115915_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","E:\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/File.hx",55,0xfe83fc43)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_3c7cff83ba115915_30_getContent)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_3c7cff83ba115915_33_getBytes)
...
void File_obj::saveContent(::String path,::String content){
            	HX_STACKFRAME(&_hx_pos_3c7cff83ba115915_38_saveContent)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_3c7cff83ba115915_44_saveBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,saveBytes,(void))
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3c7cff83ba115915_51_read)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_3c7cff83ba115915_55_write)
