...
HX_DEFINE_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_204_new,"ResetButtonOption","new",0xc052ff48,"ResetButtonOption.new","Options.hx",204,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_209_press,"ResetButtonOption","press",0xe9df0c6b,"ResetButtonOption.press","Options.hx",209,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_217_updateDisplay,"ResetButtonOption","updateDisplay",0x9c4e7021,"ResetButtonOption.updateDisplay","Options.hx",217,0x9d9a0240)

void ResetButtonOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_204_new)
HXLINE( 205)		super::__construct();
HXLINE( 206)		this->description = desc;
            	}
...
bool ResetButtonOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_209_press)
HXLINE( 210)		::flixel::FlxG_obj::save->data->__SetField(HX_("resetButton",21,e5,f4,79),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("resetButton",21,e5,f4,79),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 211)		this->display = this->updateDisplay();
HXLINE( 212)		return true;
            	}


::String ResetButtonOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_217_updateDisplay)
HXDLIN( 217)		::String _hx_tmp;
HXDLIN( 217)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("resetButton",21,e5,f4,79),::hx::paccDynamic)) ))) {
HXDLIN( 217)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 217)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 217)		return (HX_("Reset Button ",5d,3e,f2,5c) + _hx_tmp);
            	}
