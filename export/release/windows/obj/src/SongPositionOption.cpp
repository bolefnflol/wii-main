...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_164_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",164,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_169_press,"SongPositionOption","press",0xd57460a8,"SongPositionOption.press","Options.hx",169,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_177_updateDisplay,"SongPositionOption","updateDisplay",0x1eddc95e,"SongPositionOption.updateDisplay","Options.hx",177,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_164_new)
HXLINE( 165)		super::__construct();
HXLINE( 166)		this->description = desc;
            	}
...
bool SongPositionOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_169_press)
HXLINE( 170)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 171)		this->display = this->updateDisplay();
HXLINE( 172)		return true;
            	}


::String SongPositionOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_177_updateDisplay)
HXDLIN( 177)		::String _hx_tmp;
HXDLIN( 177)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 177)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 177)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 177)		return (HX_("Song Position ",4c,83,da,f1) + _hx_tmp);
            	}
