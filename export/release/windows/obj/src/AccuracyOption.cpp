...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_144_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",144,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_149_press,"AccuracyOption","press",0x7bacf5c3,"AccuracyOption.press","Options.hx",149,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_157_updateDisplay,"AccuracyOption","updateDisplay",0x7ea97179,"AccuracyOption.updateDisplay","Options.hx",157,0x9d9a0240)

void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_144_new)
HXLINE( 145)		super::__construct();
HXLINE( 146)		this->description = desc;
            	}
...
bool AccuracyOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_149_press)
HXLINE( 150)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyDisplay",09,75,5e,26),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 151)		this->display = this->updateDisplay();
HXLINE( 152)		return true;
            	}


::String AccuracyOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_157_updateDisplay)
HXDLIN( 157)		::String _hx_tmp;
HXDLIN( 157)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) ))) {
HXDLIN( 157)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 157)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 157)		return (HX_("Accuracy ",a7,4b,73,6e) + _hx_tmp);
            	}
