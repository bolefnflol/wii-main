...
HX_DEFINE_STACK_FRAME(_hx_pos_3fccbae956d84d25_526_new,"AccuracyDOption","new",0xe62cee92,"AccuracyDOption.new","Options.hx",526,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_532_press,"AccuracyDOption","press",0xad8ae235,"AccuracyDOption.press","Options.hx",532,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_540_updateDisplay,"AccuracyDOption","updateDisplay",0xd1d41feb,"AccuracyDOption.updateDisplay","Options.hx",540,0x9d9a0240)

void AccuracyDOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_526_new)
HXLINE( 527)		super::__construct();
HXLINE( 528)		this->description = desc;
            	}
...
bool AccuracyDOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_532_press)
HXLINE( 533)		 ::Dynamic _hx_tmp;
HXDLIN( 533)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),1 )) {
HXLINE( 533)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 533)			_hx_tmp = 1;
            		}
HXDLIN( 533)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyMod",09,b2,8a,86),_hx_tmp,::hx::paccDynamic);
HXLINE( 534)		this->display = this->updateDisplay();
HXLINE( 535)		return true;
            	}


::String AccuracyDOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_540_updateDisplay)
HXDLIN( 540)		::String _hx_tmp;
HXDLIN( 540)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),0 )) {
HXDLIN( 540)			_hx_tmp = HX_("Accurate",14,d1,76,d9);
            		}
            		else {
HXDLIN( 540)			_hx_tmp = HX_("Complex",10,8e,c2,50);
            		}
HXDLIN( 540)		return (HX_("Accuracy Mode: ",d0,5b,59,26) + _hx_tmp);
            	}
