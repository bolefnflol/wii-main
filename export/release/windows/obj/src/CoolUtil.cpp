...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_13_difficultyFromInt,"CoolUtil","difficultyFromInt",0xd0410307,"CoolUtil.difficultyFromInt","CoolUtil.hx",13,0x9f143813)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_52_boundTo,"CoolUtil","boundTo",0xe1951d76,"CoolUtil.boundTo","CoolUtil.hx",52,0x9f143813)
...
::String CoolUtil_obj::difficultyFromInt(int difficulty){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_13_difficultyFromInt)
HXDLIN(  13)		return ::CoolUtil_obj::difficultyArray->__get(difficulty);
            	}
...
Float CoolUtil_obj::boundTo(Float value,Float min,Float max){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_52_boundTo)
HXDLIN(  52)		return ::Math_obj::max(min,::Math_obj::min(max,value));
            	}
...
HXDLIN(   9)		difficultyArray = ::Array_obj< ::String >::fromData( _hx_array_data_c96d938b_9,3);
            	}
}
