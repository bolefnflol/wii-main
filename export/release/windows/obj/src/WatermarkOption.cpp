...
HX_DEFINE_STACK_FRAME(_hx_pos_24a6120f5d880dfd_568_new,"WatermarkOption","new",0xd9f8738b,"WatermarkOption.new","Options.hx",568,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_574_press,"WatermarkOption","press",0xcefc576e,"WatermarkOption.press","Options.hx",574,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_583_updateDisplay,"WatermarkOption","updateDisplay",0x9902f624,"WatermarkOption.updateDisplay","Options.hx",583,0x9d9a0240)

void WatermarkOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_568_new)
HXLINE( 569)		super::__construct();
HXLINE( 570)		this->description = desc;
            	}
...
bool WatermarkOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_574_press)
HXLINE( 575)		::Main_obj::watermarks = !(::Main_obj::watermarks);
HXLINE( 576)		::flixel::FlxG_obj::save->data->__SetField(HX_("watermark",a4,af,1e,e0),::Main_obj::watermarks,::hx::paccDynamic);
HXLINE( 577)		this->display = this->updateDisplay();
HXLINE( 578)		return true;
            	}


::String WatermarkOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_583_updateDisplay)
HXDLIN( 583)		::String _hx_tmp;
HXDLIN( 583)		if (::Main_obj::watermarks) {
HXDLIN( 583)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 583)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 583)		return (HX_("Watermarks ",d1,dc,17,0d) + _hx_tmp);
            	}
