...
HX_DEFINE_STACK_FRAME(_hx_pos_d6099701e1a7139c_26_new,"Date","new",0x9aa26240,"Date.new","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",26,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",30,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_34_getHours,"Date","getHours",0x256fe079,"Date.getHours","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",34,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_38_getMinutes,"Date","getMinutes",0xad798749,"Date.getMinutes","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",38,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_50_getMonth,"Date","getMonth",0x066b78ea,"Date.getMonth","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",50,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_54_getDate,"Date","getDate",0x021307c4,"Date.getDate","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",54,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_58_getDay,"Date","getDay",0x598d4986,"Date.getDay","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",58,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_94_toString,"Date","toString",0xd2a372cc,"Date.toString","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",94,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_98_now,"Date","now",0x9aa26af6,"Date.now","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",98,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",105,0x45e32428)
HX_LOCAL_STACK_FRAME(_hx_pos_d6099701e1a7139c_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","E:\\HaxeToolKit\\haxe\\std/cpp/_std/Date.hx",112,0x45e32428)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_30_getTime)
...
int Date_obj::getHours(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_34_getHours)
...
int Date_obj::getMinutes(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_38_getMinutes)
...
int Date_obj::getMonth(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_50_getMonth)
...
int Date_obj::getDate(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_54_getDate)
...
int Date_obj::getDay(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_58_getDay)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_94_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_d6099701e1a7139c_98_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_d6099701e1a7139c_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_d6099701e1a7139c_112_fromString)
