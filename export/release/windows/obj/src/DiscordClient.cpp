...
HXLINE(  14)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("966402561882071090",9c,70,95,7c))
...
HXDLIN(  39)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("Starting...",0e,3e,49,bd))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("default",c1,d8,c3,9b))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Funkin' On A Wii",a1,ab,5f,2f))));
            	}
...
HXLINE(  75)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),HX_("default",c1,d8,c3,9b))
            			...
            			->setFixed(6,HX_("largeImageText",6d,3e,2d,5e),HX_("Funkin' On A Wii",a1,ab,5f,2f))));
            	}
