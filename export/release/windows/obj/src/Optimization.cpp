...
HX_DEFINE_STACK_FRAME(_hx_pos_c9a7031a5efd77cc_484_new,"Optimization","new",0xb2b752bf,"Optimization.new","Options.hx",484,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c9a7031a5efd77cc_490_press,"Optimization","press",0x7c986ba2,"Optimization.press","Options.hx",490,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c9a7031a5efd77cc_498_updateDisplay,"Optimization","updateDisplay",0xf7dc5e58,"Optimization.updateDisplay","Options.hx",498,0x9d9a0240)

void Optimization_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_c9a7031a5efd77cc_484_new)
HXLINE( 485)		super::__construct();
HXLINE( 486)		this->description = desc;
            	}
...
bool Optimization_obj::press(){
            	HX_STACKFRAME(&_hx_pos_c9a7031a5efd77cc_490_press)
HXLINE( 491)		::flixel::FlxG_obj::save->data->__SetField(HX_("optimize",dd,8c,18,1d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("optimize",dd,8c,18,1d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 492)		this->display = this->updateDisplay();
HXLINE( 493)		return true;
            	}


::String Optimization_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_c9a7031a5efd77cc_498_updateDisplay)
HXDLIN( 498)		::String _hx_tmp;
HXDLIN( 498)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("optimize",dd,8c,18,1d),::hx::paccDynamic)) )) {
HXDLIN( 498)			_hx_tmp = HX_("ON",1f,45,00,00);
            		}
            		else {
HXDLIN( 498)			_hx_tmp = HX_("OFF",4f,2f,3c,00);
            		}
HXDLIN( 498)		return (HX_("Optimization ",33,dc,04,7e) + _hx_tmp);
            	}
