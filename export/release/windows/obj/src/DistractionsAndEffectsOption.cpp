...
HX_DEFINE_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_184_new,"DistractionsAndEffectsOption","new",0x025cdf63,"DistractionsAndEffectsOption.new","Options.hx",184,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_189_press,"DistractionsAndEffectsOption","press",0x2a356946,"DistractionsAndEffectsOption.press","Options.hx",189,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_197_updateDisplay,"DistractionsAndEffectsOption","updateDisplay",0x58e59ffc,"DistractionsAndEffectsOption.updateDisplay","Options.hx",197,0x9d9a0240)

void DistractionsAndEffectsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_184_new)
HXLINE( 185)		super::__construct();
HXLINE( 186)		this->description = desc;
            	}
...
bool DistractionsAndEffectsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_189_press)
HXLINE( 190)		::flixel::FlxG_obj::save->data->__SetField(HX_("distractions",31,13,7d,60),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 191)		this->display = this->updateDisplay();
HXLINE( 192)		return true;
            	}


::String DistractionsAndEffectsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_197_updateDisplay)
HXDLIN( 197)		::String _hx_tmp;
HXDLIN( 197)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) ))) {
HXDLIN( 197)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 197)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 197)		return (HX_("Distractions ",af,07,e4,54) + _hx_tmp);
            	}
