...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_95_soundRandomMusic,"Paths","soundRandomMusic",0x7b9b1473,"Paths.soundRandomMusic","Paths.hx",95,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_100_music,"Paths","music",0x1684a345,"Paths.music","Paths.hx",100,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_104_voices,"Paths","voices",0xbbb84fe1,"Paths.voices","Paths.hx",104,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_111_voicesEduardo,"Paths","voicesEduardo",0x51255f11,"Paths.voicesEduardo","Paths.hx",111,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_118_voicesPico,"Paths","voicesPico",0x61e56966,"Paths.voicesPico","Paths.hx",118,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_125_voicesSpooky,"Paths","voicesSpooky",0xf7ee20ac,"Paths.voicesSpooky","Paths.hx",125,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_132_inst,"Paths","inst",0x9186a526,"Paths.inst","Paths.hx",132,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_143_image,"Paths","image",0xc392f1fb,"Paths.image","Paths.hx",143,0x309ea470)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_163_video,"Paths","video",0x3d25e71b,"Paths.video","Paths.hx",163,0x309ea470)
...
::String Paths_obj::soundRandomMusic(::String key,int min,int max,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_95_soundRandomMusic)
HXDLIN(  95)		return ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (key + ::flixel::FlxG_obj::random->_hx_int(min,max,null()))) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC4(Paths_obj,soundRandomMusic,return )

::String Paths_obj::music(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_100_music)
HXDLIN( 100)		return ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            	}
...
::String Paths_obj::voices(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_104_voices)
HXLINE( 105)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 107)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,voices,return )

::String Paths_obj::voicesEduardo(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_111_voicesEduardo)
HXLINE( 112)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 114)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/VoicesEduardo.",2c,df,7e,02)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,voicesEduardo,return )

::String Paths_obj::voicesPico(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_118_voicesPico)
HXLINE( 119)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 121)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/VoicesPico.",79,fd,70,19)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,voicesPico,return )

::String Paths_obj::voicesSpooky(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_125_voicesSpooky)
HXLINE( 126)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 128)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/VoicesSpookyKids.",c6,76,f4,91)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,voicesSpooky,return )

::String Paths_obj::inst(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_132_inst)
HXLINE( 133)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 134)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 135)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 135)			goto _hx_goto_19;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 136)			songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 136)			goto _hx_goto_19;
            		}
            		_hx_goto_19:;
HXLINE( 138)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
::String Paths_obj::image(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_143_image)
HXDLIN( 143)		return ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            	}
...
::String Paths_obj::video(::String key){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_163_video)
HXDLIN( 163)		return (HX_("assets/videos/",cb,c4,dd,db) + key);
            	}
...
bool Paths_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"voicesPico") ) { outValue = voicesPico_dyn(); return true; }
		break;
	case 11:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"voicesSpooky") ) { outValue = voicesSpooky_dyn(); return true; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"voicesEduardo") ) { outValue = voicesEduardo_dyn(); return true; }
		break;
	case 14:
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"soundRandomMusic") ) { outValue = soundRandomMusic_dyn(); return true; }
		break;
	case 19:
...
static ::String Paths_obj_sStaticFields[] = {
	...
	HX_("soundRandomMusic",13,23,93,13),
	HX_("music",a5,d0,5a,10),
	HX_("voices",81,d6,49,5d),
	HX_("voicesEduardo",71,ec,f7,9a),
	HX_("voicesPico",06,c0,ce,71),
	HX_("voicesSpooky",4c,5f,d2,d5),
