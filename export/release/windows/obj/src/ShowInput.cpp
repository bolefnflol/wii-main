...
HX_DEFINE_STACK_FRAME(_hx_pos_635a2d013c5acddb_244_new,"ShowInput","new",0x331b851f,"ShowInput.new","Options.hx",244,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_249_press,"ShowInput","press",0x0435f602,"ShowInput.press","Options.hx",249,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_257_updateDisplay,"ShowInput","updateDisplay",0x219b48b8,"ShowInput.updateDisplay","Options.hx",257,0x9d9a0240)

void ShowInput_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_244_new)
HXLINE( 245)		super::__construct();
HXLINE( 246)		this->description = desc;
            	}
...
bool ShowInput_obj::press(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_249_press)
HXLINE( 250)		::flixel::FlxG_obj::save->data->__SetField(HX_("inputShow",27,92,7d,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("inputShow",27,92,7d,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 251)		this->display = this->updateDisplay();
HXLINE( 252)		return true;
            	}


::String ShowInput_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_257_updateDisplay)
HXDLIN( 257)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("inputShow",27,92,7d,13),::hx::paccDynamic)) )) {
HXDLIN( 257)			return HX_("Extended Score Info",23,00,94,83);
            		}
            		else {
HXDLIN( 257)			return HX_("Minimalized Info",bd,6b,6e,01);
            		}
