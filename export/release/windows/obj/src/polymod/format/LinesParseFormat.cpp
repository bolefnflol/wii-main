...
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_498_print,"polymod.format.LinesParseFormat","print",0x66776f89,"polymod.format.LinesParseFormat.print","polymod/format/ParseRules.hx",498,0xc5c5c43b)
...
::String LinesParseFormat_obj::print(::Array< ::String > lines){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_498_print)
HXDLIN( 498)		return lines->join(this->getEndl());
            	}
