...
HX_DEFINE_STACK_FRAME(_hx_pos_be220568d9d5b1fe_513_new,"polymod.format.XMLParseFormat","new",0x075e5a24,"polymod.format.XMLParseFormat.new","polymod/format/ParseRules.hx",513,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_534_parse,"polymod.format.XMLParseFormat","parse",0x836912f7,"polymod.format.XMLParseFormat.parse","polymod/format/ParseRules.hx",534,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_539_append,"polymod.format.XMLParseFormat","append",0x1ad2ca96,"polymod.format.XMLParseFormat.append","polymod/format/ParseRules.hx",539,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_550_merge,"polymod.format.XMLParseFormat","merge",0xcbda257c,"polymod.format.XMLParseFormat.merge","polymod/format/ParseRules.hx",550,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_578_print,"polymod.format.XMLParseFormat","print",0x8e9edaf1,"polymod.format.XMLParseFormat.print","polymod/format/ParseRules.hx",578,0xc5c5c43b)
namespace polymod{
namespace format{
...
void XMLParseFormat_obj::__construct(::hx::Null< bool >  __o_prettyPrint,::Array< ::String > headers,::Array< ::String > footers){
            	...
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_513_new)
HXLINE( 516)		this->prettyPrint = false;
HXLINE( 522)		if (::hx::IsNull( headers )) {
HXLINE( 523)			headers = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 524)		if (::hx::IsNull( footers )) {
HXLINE( 525)			footers = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 526)		this->stripHeaders = headers;
HXLINE( 527)		this->stripFooters = footers;
HXLINE( 528)		this->prettyPrint = prettyPrint;
HXLINE( 529)		this->format = ::polymod::format::TextFileFormat_obj::XML_dyn();
            	}
...
void *XMLParseFormat_obj::_hx_getInterface(int inHash) {
 ...
 ::Xml XMLParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_534_parse)
HXDLIN( 534)		return ::Xml_obj::parse(str);
            	}
...
::String XMLParseFormat_obj::append(::String baseText,::String appendText,::String id){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_539_append)
HXDLIN( 539)		bool _hx_tmp;
HXDLIN( 539)		if (::hx::IsNotNull( this->stripHeaders )) {
HXDLIN( 539)			_hx_tmp = ::hx::IsNotNull( this->stripFooters );
            		}
            		else {
HXDLIN( 539)			_hx_tmp = false;
            		}
HXDLIN( 539)		if (_hx_tmp) {
HXLINE( 541)			return ::polymod::util::Util_obj::appendSpecialXML(baseText,appendText,this->stripHeaders,this->stripFooters);
            		}
            		else {
HXLINE( 545)			return ::polymod::util::Util_obj::appendXML(baseText,appendText);
            		}
...
::String XMLParseFormat_obj::merge(::String baseText,::String mergeText,::String id){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_550_merge)
HXLINE( 551)		 ::Xml basex = null();
HXLINE( 552)		 ::Xml mergex = null();
HXLINE( 554)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 556)			basex = ::Xml_obj::parse(baseText);
HXLINE( 557)			mergex = ::Xml_obj::parse(mergeText);
            		} catch( ::Dynamic _hx_e) {
...
HXDLIN( 559)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 561)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((((HX_("Error parsing XML files during merge (",5b,0b,12,8a) + id) + HX_(") ",d7,23,00,00)) + ::Std_obj::string(msg))));
            			}
            			else {
...
HXLINE( 564)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 566)			::polymod::format::XMLMerge_obj::mergeXMLNodes(basex,mergex);
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
...
HXDLIN( 568)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 570)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((((HX_("Error combining XML files during merge (",8f,b2,77,22) + id) + HX_(") ",d7,23,00,00)) + ::Std_obj::string(msg))));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
            		}
HXLINE( 573)		return this->print(basex);
            	}
...
::String XMLParseFormat_obj::print( ::Xml xml){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_578_print)
HXDLIN( 578)		return ::haxe::xml::Printer_obj::print(xml,this->prettyPrint);
            	}
