...
HX_DEFINE_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1037_new,"polymod.format.PlainTextParseFormat","new",0x46979564,"polymod.format.PlainTextParseFormat.new","polymod/format/ParseRules.hx",1037,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1042_parse,"polymod.format.PlainTextParseFormat","parse",0xefd79e37,"polymod.format.PlainTextParseFormat.parse","polymod/format/ParseRules.hx",1042,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1046_append,"polymod.format.PlainTextParseFormat","append",0x8f1e1756,"polymod.format.PlainTextParseFormat.append","polymod/format/ParseRules.hx",1046,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1073_merge,"polymod.format.PlainTextParseFormat","merge",0x3848b0bc,"polymod.format.PlainTextParseFormat.merge","polymod/format/ParseRules.hx",1073,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1080_print,"polymod.format.PlainTextParseFormat","print",0xfb0d6631,"polymod.format.PlainTextParseFormat.print","polymod/format/ParseRules.hx",1080,0xc5c5c43b)
namespace polymod{
namespace format{

void PlainTextParseFormat_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1037_new)
HXDLIN(1037)		this->format = ::polymod::format::TextFileFormat_obj::PLAINTEXT_dyn();
            	}
...
::String PlainTextParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1042_parse)
HXDLIN(1042)		return str;
            	}
...
::String PlainTextParseFormat_obj::append(::String baseText,::String appendText,::String id){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1046_append)
HXLINE(1047)		::String lastChar = ::polymod::util::Util_obj::uCharAt(baseText,(::polymod::util::Util_obj::uLength(baseText) - 1));
HXLINE(1048)		::String lastLastChar = ::polymod::util::Util_obj::uCharAt(baseText,(::polymod::util::Util_obj::uLength(baseText) - 1));
HXLINE(1049)		::String joiner = HX_("",00,00,00,00);
HXLINE(1051)		::String endLine = HX_("\n",0a,00,00,00);
HXLINE(1053)		int crIndex = ::polymod::util::Util_obj::uIndexOf(baseText,HX_("\r",0d,00,00,00),null());
HXLINE(1054)		int lfIndex = ::polymod::util::Util_obj::uIndexOf(baseText,HX_("\n",0a,00,00,00),null());
HXLINE(1056)		if ((crIndex != -1)) {
HXLINE(1058)			if ((lfIndex == (crIndex + 1))) {
HXLINE(1060)				endLine = HX_("\r\n",5d,0b,00,00);
            			}
            		}
HXLINE(1064)		if ((lastChar != HX_("\n",0a,00,00,00))) {
HXLINE(1066)			joiner = endLine;
            		}
HXLINE(1069)		return ::polymod::util::Util_obj::uCombine(::Array_obj< ::String >::__new(3)->init(0,baseText)->init(1,joiner)->init(2,appendText));
            	}
...
::String PlainTextParseFormat_obj::merge(::String baseText,::String mergeText,::String id){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1073_merge)
HXLINE(1074)		::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),((HX_("(",28,00,00,00) + id) + HX_(") Plain text does not support merging!",cb,64,8e,4a)),null());
HXLINE(1075)		return baseText;
            	}
...
::String PlainTextParseFormat_obj::print(::String str){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1080_print)
HXDLIN(1080)		return str;
            	}
