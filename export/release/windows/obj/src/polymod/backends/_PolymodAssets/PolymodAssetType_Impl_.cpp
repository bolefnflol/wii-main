...
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_204_fromString,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","fromString",0xa9047b18,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.fromString","polymod/backends/PolymodAssets.hx",204,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_191_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",191,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_192_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",192,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_193_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",193,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_194_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",194,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_195_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",195,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_196_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",196,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_197_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",197,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_198_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",198,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_199_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",199,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_200_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",200,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_201_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",201,0xd8b6783c)
namespace polymod{
namespace backends{
...
::String PolymodAssetType_Impl__obj::fromString(::String str){
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_204_fromString)
HXLINE( 205)		str = str.toUpperCase();
HXLINE( 206)		::String _hx_switch_0 = str;
...
HXLINE( 209)			return str;
HXDLIN( 209)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE( 211)			return HX_("UNKNOWN",6a,f7,4e,61);
            		}
            		_hx_goto_0:;
...
{
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_191_boot)
HXDLIN( 191)		BYTES = HX_("BYTES",4b,40,86,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_192_boot)
HXDLIN( 192)		TEXT = HX_("TEXT",ad,94,ba,37);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_193_boot)
HXDLIN( 193)		IMAGE = HX_("IMAGE",3b,57,57,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_194_boot)
HXDLIN( 194)		VIDEO = HX_("VIDEO",5b,4c,ea,b4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_195_boot)
HXDLIN( 195)		FONT = HX_("FONT",cf,25,81,2e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_196_boot)
HXDLIN( 196)		AUDIO_GENERIC = HX_("AUDIO_GENERIC",2e,f6,26,23);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_197_boot)
HXDLIN( 197)		AUDIO_MUSIC = HX_("AUDIO_MUSIC",fc,6c,05,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_198_boot)
HXDLIN( 198)		AUDIO_SOUND = HX_("AUDIO_SOUND",26,29,77,b8);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_199_boot)
HXDLIN( 199)		MANIFEST = HX_("MANIFEST",af,8b,af,29);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_200_boot)
HXDLIN( 200)		TEMPLATE = HX_("TEMPLATE",3a,78,cd,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_201_boot)
HXDLIN( 201)		UNKNOWN = HX_("UNKNOWN",6a,f7,4e,61);
            	}
}
