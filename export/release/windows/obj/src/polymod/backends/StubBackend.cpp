...
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_69_getPath,"polymod.backends.StubBackend","getPath",0xccf0f4bc,"polymod.backends.StubBackend.getPath","polymod/backends/StubBackend.hx",69,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_74_list,"polymod.backends.StubBackend","list",0x6533c65d,"polymod.backends.StubBackend.list","polymod/backends/StubBackend.hx",74,0xad5ab72f)
...
::String StubBackend_obj::getPath(::String id){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_69_getPath)
...
::Array< ::String > StubBackend_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_74_list)
HXDLIN(  74)		return ::Array_obj< ::String >::__new(0);
            	}
