...
HX_DEFINE_STACK_FRAME(_hx_pos_04fa384cfca16a40_576_new,"polymod.backends._LimeBackend.IdAndLibrary","new",0x62fe42a8,"polymod.backends._LimeBackend.IdAndLibrary.new","polymod/backends/LimeBackend.hx",576,0xcff7dfd6)
namespace polymod{
namespace backends{
...
void IdAndLibrary_obj::__construct(::String id, ::haxe::ds::StringMap libs, ::polymod::backends::LimeModLibrary l){
            	HX_STACKFRAME(&_hx_pos_04fa384cfca16a40_576_new)
HXLINE( 577)		this->fallbackId = id;
HXLINE( 578)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 579)		this->lib = id.substring(0,colonIndex);
HXLINE( 580)		this->nakedId = id.substring((colonIndex + 1),null());
HXLINE( 581)		if (::hx::IsNotNull( l )) {
HXLINE( 583)			this->library = l;
            		}
            		else {
HXLINE( 585)			if (::hx::IsNotNull( libs )) {
HXLINE( 587)				bool _hx_tmp;
HXDLIN( 587)				if ((this->lib != HX_("",00,00,00,00))) {
HXLINE( 587)					_hx_tmp = ::hx::IsNull( this->lib );
            				}
            				else {
HXLINE( 587)					_hx_tmp = true;
            				}
HXDLIN( 587)				if (_hx_tmp) {
HXLINE( 589)					this->lib = HX_("default",c1,d8,c3,9b);
            				}
HXLINE( 591)				this->library = ( ( ::polymod::backends::LimeModLibrary)(libs->get(this->lib)) );
            			}
            		}
HXLINE( 593)		bool _hx_tmp;
HXDLIN( 593)		bool _hx_tmp1;
HXDLIN( 593)		if (::hx::IsNotNull( this->library )) {
HXLINE( 593)			_hx_tmp1 = ::hx::IsNotNull( this->library->pathPrefix );
            		}
            		else {
HXLINE( 593)			_hx_tmp1 = false;
            		}
HXDLIN( 593)		if (_hx_tmp1) {
HXLINE( 593)			_hx_tmp = (this->library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 593)			_hx_tmp = false;
            		}
HXDLIN( 593)		if (_hx_tmp) {
HXLINE( 595)			this->modId = ((this->library->pathPrefix + HX_("/",2f,00,00,00)) + this->nakedId);
            		}
HXLINE( 597)		this->modId = this->nakedId;
            	}
