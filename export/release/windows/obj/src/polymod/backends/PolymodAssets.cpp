...
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_142_exists,"polymod.backends.PolymodAssets","exists",0x9c209928,"polymod.backends.PolymodAssets.exists","polymod/backends/PolymodAssets.hx",142,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_147_getBytes,"polymod.backends.PolymodAssets","getBytes",0xe73dfe41,"polymod.backends.PolymodAssets.getBytes","polymod/backends/PolymodAssets.hx",147,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_152_getText,"polymod.backends.PolymodAssets","getText",0xfba7e397,"polymod.backends.PolymodAssets.getText","polymod/backends/PolymodAssets.hx",152,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_157_getPath,"polymod.backends.PolymodAssets","getPath",0xf8fffc8f,"polymod.backends.PolymodAssets.getPath","polymod/backends/PolymodAssets.hx",157,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_162_list,"polymod.backends.PolymodAssets","list",0x3565ecaa,"polymod.backends.PolymodAssets.list","polymod/backends/PolymodAssets.hx",162,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_177_autoDetectFramework,"polymod.backends.PolymodAssets","autoDetectFramework",0x6c71ec20,"polymod.backends.PolymodAssets.autoDetectFramework","polymod/backends/PolymodAssets.hx",177,0xd8b6783c)
namespace polymod{
namespace backends{
...
HXLINE(  93)				backend =  ::polymod::backends::HEAPSBackend_obj::__alloc( HX_CTX );
            			...
            			break;
            			case (int)5: {
HXLINE( 101)				if (::hx::IsNotNull( params->__Field(HX_("customBackend",63,24,96,a5),::hx::paccDynamic) )) {
...
HXLINE( 107)					::polymod::Polymod_obj::error(HX_("undefined_custom_backend",55,22,be,1a),HX_("params.customBackend was not defined!",c1,92,8f,a0),null());
...
HXLINE( 112)		if (::hx::IsNull( backend )) {
HXLINE( 114)			::polymod::Polymod_obj::error(HX_("failed_create_backend",13,58,1e,db),((HX_("could not create a backend for framework(",04,e6,ea,e7) + ::Std_obj::string(framework)) + HX_(")!",d8,23,00,00)),null());
HXLINE( 115)			return null();
            		}
HXLINE( 118)		if (::hx::IsNotNull( ::polymod::backends::PolymodAssets_obj::library )) {
HXLINE( 120)			::polymod::backends::PolymodAssets_obj::library->destroy();
            		}
HXLINE( 123)		::polymod::backends::PolymodAssets_obj::library =  ::polymod::backends::PolymodAssetLibrary_obj::__alloc( HX_CTX , ::Dynamic(::hx::Anon_obj::Create(6)
...
HXLINE( 132)		if (::polymod::backends::IBackend_obj::init(backend, ::Dynamic(params->__Field(HX_("frameworkParams",64,76,eb,26),::hx::paccDynamic)))) {
HXLINE( 134)			return ::polymod::backends::PolymodAssets_obj::library;
            		}
            		else {
...
bool PolymodAssets_obj::exists(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_142_exists)
HXDLIN( 142)		return ::polymod::backends::PolymodAssets_obj::library->exists(id);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,exists,return )
 ...
 ::haxe::io::Bytes PolymodAssets_obj::getBytes(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_147_getBytes)
HXDLIN( 147)		return ::polymod::backends::PolymodAssets_obj::library->getBytes(id);
            	}
...
::String PolymodAssets_obj::getText(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_152_getText)
HXDLIN( 152)		return ::polymod::backends::PolymodAssets_obj::library->getText(id);
            	}
...
::String PolymodAssets_obj::getPath(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_157_getPath)
HXDLIN( 157)		return ::polymod::backends::PolymodAssets_obj::library->getPath(id);
            	}
...
::Array< ::String > PolymodAssets_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_162_list)
HXDLIN( 162)		return ::polymod::backends::PolymodAssets_obj::library->list(type);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,list,return )
 ...
 ::polymod::Framework PolymodAssets_obj::autoDetectFramework(){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_177_autoDetectFramework)
HXDLIN( 177)		return ::polymod::Framework_obj::OPENFL_dyn();
            	}
