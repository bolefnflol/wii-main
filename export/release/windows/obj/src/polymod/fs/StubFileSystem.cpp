...
HX_DEFINE_STACK_FRAME(_hx_pos_0133b8a666cd821f_33_new,"polymod.fs.StubFileSystem","new",0x945ac6f4,"polymod.fs.StubFileSystem.new","polymod/fs/StubFileSystem.hx",33,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_37_exists,"polymod.fs.StubFileSystem","exists",0xefea7bc8,"polymod.fs.StubFileSystem.exists","polymod/fs/StubFileSystem.hx",37,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_40_isDirectory,"polymod.fs.StubFileSystem","isDirectory",0xe74353b7,"polymod.fs.StubFileSystem.isDirectory","polymod/fs/StubFileSystem.hx",40,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_43_readDirectory,"polymod.fs.StubFileSystem","readDirectory",0xf6dfe3cb,"polymod.fs.StubFileSystem.readDirectory","polymod/fs/StubFileSystem.hx",43,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_46_getFileContent,"polymod.fs.StubFileSystem","getFileContent",0xa80c6b13,"polymod.fs.StubFileSystem.getFileContent","polymod/fs/StubFileSystem.hx",46,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_49_getFileBytes,"polymod.fs.StubFileSystem","getFileBytes",0x448ddbc5,"polymod.fs.StubFileSystem.getFileBytes","polymod/fs/StubFileSystem.hx",49,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_52_readDirectoryRecursive,"polymod.fs.StubFileSystem","readDirectoryRecursive",0x27635627,"polymod.fs.StubFileSystem.readDirectoryRecursive","polymod/fs/StubFileSystem.hx",52,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_55_scanMods,"polymod.fs.StubFileSystem","scanMods",0x2630b07a,"polymod.fs.StubFileSystem.scanMods","polymod/fs/StubFileSystem.hx",55,0x6bc1a85c)
HX_LOCAL_STACK_FRAME(_hx_pos_0133b8a666cd821f_58_getMetadata,"polymod.fs.StubFileSystem","getMetadata",0x5e8b54b9,"polymod.fs.StubFileSystem.getMetadata","polymod/fs/StubFileSystem.hx",58,0x6bc1a85c)
namespace polymod{
namespace fs{

void StubFileSystem_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_33_new)
            	}
...
bool StubFileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_37_exists)
...
bool StubFileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_40_isDirectory)
...
::Array< ::String > StubFileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_43_readDirectory)
HXDLIN(  43)		return ::Array_obj< ::String >::__new(0);
            	}
...
::String StubFileSystem_obj::getFileContent(::String path){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_46_getFileContent)
...
HX_DEFINE_DYNAMIC_FUNC1(StubFileSystem_obj,getFileContent,return )
 ...
 ::haxe::io::Bytes StubFileSystem_obj::getFileBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_49_getFileBytes)
...
::Array< ::String > StubFileSystem_obj::readDirectoryRecursive(::String path){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_52_readDirectoryRecursive)
HXDLIN(  52)		return ::Array_obj< ::String >::__new(0);
            	}
...
::Array< ::String > StubFileSystem_obj::scanMods(){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_55_scanMods)
HXDLIN(  55)		return ::Array_obj< ::String >::__new(0);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(StubFileSystem_obj,scanMods,return )
 ...
 ::polymod::ModMetadata StubFileSystem_obj::getMetadata(::String modId){
            	HX_STACKFRAME(&_hx_pos_0133b8a666cd821f_58_getMetadata)
...
::hx::ObjectPtr< StubFileSystem_obj > StubFileSystem_obj::__new() {
	::hx::ObjectPtr< StubFileSystem_obj > __this = new StubFileSystem_obj();
	__this->__construct();
	return __this;
}

::hx::ObjectPtr< StubFileSystem_obj > StubFileSystem_obj::__alloc(::hx::Ctx *_hx_ctx) {
