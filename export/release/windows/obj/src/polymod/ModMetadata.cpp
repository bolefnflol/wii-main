...
HX_DEFINE_STACK_FRAME(_hx_pos_bf85bbb123aa7472_483_new,"polymod.ModMetadata","new",0xb8bfb12b,"polymod.ModMetadata.new","polymod/Polymod.hx",483,0xd80c6d61)
HX_LOCAL_STACK_FRAME(_hx_pos_bf85bbb123aa7472_487_toJsonStr,"polymod.ModMetadata","toJsonStr",0xb10a2a39,"polymod.ModMetadata.toJsonStr","polymod/Polymod.hx",487,0xd80c6d61)
HX_LOCAL_STACK_FRAME(_hx_pos_bf85bbb123aa7472_506_fromJsonStr,"polymod.ModMetadata","fromJsonStr",0x1a576eea,"polymod.ModMetadata.fromJsonStr","polymod/Polymod.hx",506,0xd80c6d61)
namespace polymod{

void ModMetadata_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bf85bbb123aa7472_483_new)
            	}
...
::String ModMetadata_obj::toJsonStr(){
            	HX_STACKFRAME(&_hx_pos_bf85bbb123aa7472_487_toJsonStr)
HXLINE( 488)		 ::Dynamic json =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 489)		::Reflect_obj::setField(json,HX_("title",98,15,3b,10),this->title);
HXLINE( 490)		::Reflect_obj::setField(json,HX_("description",fc,08,1d,5f),this->description);
HXLINE( 491)		::Reflect_obj::setField(json,HX_("author",8b,ea,7b,73),this->author);
HXLINE( 492)		::Reflect_obj::setField(json,HX_("api_version",33,67,89,30),this->apiVersion->toString());
HXLINE( 493)		::Reflect_obj::setField(json,HX_("mod_version",5b,e9,f4,5b),this->modVersion->toString());
HXLINE( 494)		::Reflect_obj::setField(json,HX_("license",81,d3,48,ca),this->license);
HXLINE( 495)		::Reflect_obj::setField(json,HX_("license_ref",55,46,81,a0),this->licenseRef);
HXLINE( 496)		 ::Dynamic meta =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 497)		{
HXLINE( 497)			 ::Dynamic key = this->metaData->keys();
HXDLIN( 497)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 497)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 499)				::Reflect_obj::setField(meta,key1,this->metaData->get(key1));
            			}
            		}
HXLINE( 501)		::Reflect_obj::setField(json,HX_("metadata",6f,e7,19,40),meta);
HXLINE( 502)		 ::Dynamic replacer = null();
HXDLIN( 502)		return ::haxe::format::JsonPrinter_obj::print(json,replacer,HX_("    ",00,38,3f,15));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ModMetadata_obj,toJsonStr,return )
 ...
 ::polymod::ModMetadata ModMetadata_obj::fromJsonStr(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_bf85bbb123aa7472_506_fromJsonStr)
HXLINE( 507)		 ::polymod::ModMetadata m =  ::polymod::ModMetadata_obj::__alloc( HX_CTX );
HXLINE( 508)		 ::Dynamic json =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,str)->doParse();
HXLINE( 509)		m->title = ::polymod::format::JsonHelp_obj::str(json,HX_("title",98,15,3b,10),null());
HXLINE( 510)		m->description = ::polymod::format::JsonHelp_obj::str(json,HX_("description",fc,08,1d,5f),null());
HXLINE( 511)		m->author = ::polymod::format::JsonHelp_obj::str(json,HX_("author",8b,ea,7b,73),null());
HXLINE( 512)		::String apiVersionStr = ::polymod::format::JsonHelp_obj::str(json,HX_("api_version",33,67,89,30),null());
HXLINE( 513)		::String modVersionStr = ::polymod::format::JsonHelp_obj::str(json,HX_("mod_version",5b,e9,f4,5b),null());
HXLINE( 514)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 516)			m->apiVersion = ::polymod::util::SemanticVersion_obj::fromString(apiVersionStr);
            		} catch( ::Dynamic _hx_e) {
...
HXDLIN( 518)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 520)				::polymod::Polymod_obj::error(HX_("parse_mod_api_version",aa,ef,f5,4c),(((HX_("Error parsing api version: (",d8,67,2c,ab) + ::Std_obj::string(msg)) + HX_(") _polymod_meta.json was : ",5d,6f,2f,34)) + str),null());
...
HXLINE( 523)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 525)			m->modVersion = ::polymod::util::SemanticVersion_obj::fromString(modVersionStr);
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
...
HXDLIN( 527)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 529)				::polymod::Polymod_obj::error(HX_("parse_mod_version",0f,28,c5,d6),(((HX_("Error parsing mod version: (",b0,ae,ce,3c) + ::Std_obj::string(msg)) + HX_(") _polymod_meta.json was : ",5d,6f,2f,34)) + str),null());
...
HXLINE( 532)		m->license = ::polymod::format::JsonHelp_obj::str(json,HX_("license",81,d3,48,ca),null());
HXLINE( 533)		m->licenseRef = ::polymod::format::JsonHelp_obj::str(json,HX_("license_ref",55,46,81,a0),null());
HXLINE( 534)		m->metaData = ::polymod::format::JsonHelp_obj::mapStr(json,HX_("metadata",6f,e7,19,40));
HXLINE( 535)		return m;
            	}
