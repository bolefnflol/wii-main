...
HX_DEFINE_STACK_FRAME(_hx_pos_bfb78df8014a2c60_547_new,"polymod.PolymodError","new",0xa579457c,"polymod.PolymodError.new","polymod/Polymod.hx",547,0xd80c6d61)
namespace polymod{

void PolymodError_obj::__construct( ::polymod::PolymodErrorType severity,::String code,::String message,::String origin){
            	HX_STACKFRAME(&_hx_pos_bfb78df8014a2c60_547_new)
HXLINE( 548)		this->severity = severity;
HXLINE( 549)		this->code = code;
HXLINE( 550)		this->message = message;
HXLINE( 551)		this->origin = origin;
            	}
