...
HX_DEFINE_STACK_FRAME(_hx_pos_59e1436159e1af96_224_new,"FlashingLightsOption","new",0xa84c7996,"FlashingLightsOption.new","Options.hx",224,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_229_press,"FlashingLightsOption","press",0xdee63639,"FlashingLightsOption.press","Options.hx",229,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_237_updateDisplay,"FlashingLightsOption","updateDisplay",0xd86917ef,"FlashingLightsOption.updateDisplay","Options.hx",237,0x9d9a0240)

void FlashingLightsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_224_new)
...
bool FlashingLightsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_229_press)
HXLINE( 230)		::flixel::FlxG_obj::save->data->__SetField(HX_("flashing",32,85,e8,99),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 231)		this->display = this->updateDisplay();
HXLINE( 232)		return true;
            	}


::String FlashingLightsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_237_updateDisplay)
HXDLIN( 237)		::String _hx_tmp;
HXDLIN( 237)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) ))) {
HXDLIN( 237)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 237)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 237)		return (HX_("Flashing Lights ",b5,a5,19,88) + _hx_tmp);
            	}
