...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_56_init,"Main","init",0xea732345,"Main.init","Main.hx",56,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_69_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",69,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_100_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",100,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_105_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",105,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_110_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",110,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_115_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",115,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_120_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",120,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_36_main,"Main","main",0xed0e206e,"Main.main","Main.hx",36,0x087e5c05)
...
HXLINE(  24)		this->initialState = ::hx::ClassOf< ::WatchOut >();
HXLINE(  23)		this->gameHeight = 720;
HXLINE(  22)		this->gameWidth = 1280;
HXLINE(  41)		super::__construct();
HXLINE(  43)		if (::hx::IsNotNull( this->stage )) {
HXLINE(  45)			this->init(null());
            		}
            		else {
HXLINE(  49)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_56_init)
HXLINE(  57)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  59)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
HXLINE(  62)		this->setupGame();
HXLINE(  64)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("comeDead",c8,05,ef,0f),::hx::paccDynamic)) )) {
HXLINE(  65)			::haxe::Log_obj::trace(HX_("come dead is true boi",40,7a,37,41),::hx::SourceInfo(HX_("source/Main.hx",91,d3,a7,40),65,HX_("Main",59,64,2f,33),HX_("init",10,3b,bb,45)));
            		}
            	}
...
void Main_obj::setupGame(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_69_setupGame)
HXLINE(  70)		int stageWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  71)		int stageHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXLINE(  73)		if ((this->zoom == -1)) {
HXLINE(  75)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  76)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  77)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  78)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  79)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
HXLINE(  82)		this->game =  ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen);
HXLINE(  83)		this->addChild(this->game);
HXLINE(  86)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  87)		this->addChild(this->fpsCounter);
HXLINE(  88)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_100_toggleFPS)
HXDLIN( 100)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_105_changeFPSColor)
HXDLIN( 105)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_110_setFPSCap)
HXDLIN( 110)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_115_getFPSCap)
HXDLIN( 115)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_120_getFPS)
HXDLIN( 120)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}
...
void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_36_main)
HXDLIN(  36)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  36)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
