...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Funkin' On A Wii",a1,ab,5f,2f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("bolefnf",58,7c,2b,bf));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Funkin' On A Wii",a1,ab,5f,2f));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Funkin' On A Wii (Mod Owned By B.O.L.E)",78,47,b2,68));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.bolefnf.funkinonawii",09,2b,1a,ad));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.1",73,94,24,00));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Funkin' On A Wii (Mod Owned By B.O.L.E)",78,47,b2,68))
