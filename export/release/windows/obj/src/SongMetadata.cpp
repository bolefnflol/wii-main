...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_394_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",394,0x0d86f62d)
...
HXLINE( 398)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 397)		this->week = 0;
HXLINE( 396)		this->songName = HX_("",00,00,00,00);
HXLINE( 402)		this->songName = song;
HXLINE( 403)		this->week = week;
HXLINE( 404)		this->songCharacter = songCharacter;
            	}
