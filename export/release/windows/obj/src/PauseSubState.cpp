...
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_267_destroy,"PauseSubState","destroy",0xc2ba82f3,"PauseSubState.destroy","PauseSubState.hx",267,0x953dc7b7)
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_274_changeSelection,"PauseSubState","changeSelection",0x8f960fb5,"PauseSubState.changeSelection","PauseSubState.hx",274,0x953dc7b7)
...
HXLINE( 224)				::SelectPlayable_obj::bfMarioHatSelected = false;
HXLINE( 225)				::SelectPlayable_obj::picoLuigiHatSelected = false;
HXLINE( 226)				::SelectPlayable_obj::spookyHatsSelected = false;
HXLINE( 227)				::SelectPlayable_obj::eduardoSelected = false;
HXLINE( 229)				::SelectPlayable_obj::_hx_char = HX_("",00,00,00,00);
HXLINE( 230)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 232)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 233)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 234)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 236)				if (::PlayState_obj::isStoryMode) {
HXLINE( 238)					 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 238)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 238)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            				else {
HXLINE( 242)					 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 242)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 242)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
HXLINE( 246)				if (::hx::IsNotNull( ::PlayState_obj::luaModchart )) {
HXLINE( 248)					::PlayState_obj::luaModchart->die();
HXLINE( 249)					::PlayState_obj::luaModchart = null();
            				}
HXLINE( 252)				if (::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),290 )) {
HXLINE( 253)					::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->setFPSCap(( (Float)(290) ));
            				}
HXLINE( 255)				{
HXLINE( 255)					 ::flixel::FlxState nextState =  ::FNFmenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 223)				goto _hx_goto_6;
            			...
            			if (  (_hx_switch_1==HX_("Options",3e,5b,4f,ad)) ){
HXLINE( 220)				::PlayState_obj::optionsFromPlaystate = true;
HXLINE( 221)				{
HXLINE( 221)					 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXDLIN( 259)		bool _hx_tmp1 = _this->keyManager->checkStatusUnsafe(74,_this->status);
            	}


void PauseSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_267_destroy)
HXLINE( 268)		this->pauseMusic->destroy();
...
void PauseSubState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_274_changeSelection)
HXLINE( 275)		 ::PauseSubState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 275)		_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 277)		if ((this->curSelected < 0)) {
HXLINE( 278)			this->curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 279)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 280)			this->curSelected = 0;
            		}
HXLINE( 282)		int bullShit = 0;
HXLINE( 284)		{
HXLINE( 284)			int _g = 0;
HXDLIN( 284)			::Array< ::Dynamic> _g1 = this->grpMenuShit->members;
HXDLIN( 284)			while((_g < _g1->length)){
HXLINE( 284)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 284)				_g = (_g + 1);
