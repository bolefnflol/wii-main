...
HX_DEFINE_STACK_FRAME(_hx_pos_7861c1e414cf422e_462_new,"RainbowFPSOption","new",0xb4ce913a,"RainbowFPSOption.new","Options.hx",462,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_468_press,"RainbowFPSOption","press",0xa1d87edd,"RainbowFPSOption.press","Options.hx",468,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_477_updateDisplay,"RainbowFPSOption","updateDisplay",0xe58aa493,"RainbowFPSOption.updateDisplay","Options.hx",477,0x9d9a0240)

void RainbowFPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_462_new)
HXLINE( 463)		super::__construct();
HXLINE( 464)		this->description = desc;
            	}
...
bool RainbowFPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_468_press)
HXLINE( 469)		::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 470)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->changeFPSColor(-1);
...
::String RainbowFPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_477_updateDisplay)
HXDLIN( 477)		::String _hx_tmp;
HXDLIN( 477)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) ))) {
HXDLIN( 477)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 477)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 477)		return (HX_("FPS Rainbow ",81,45,9e,9c) + _hx_tmp);
            	}
