...
HX_DEFINE_STACK_FRAME(_hx_pos_94908c72a49529df_505_new,"NPSDisplayOption","new",0x0195d6b8,"NPSDisplayOption.new","Options.hx",505,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_511_press,"NPSDisplayOption","press",0x231a9fdb,"NPSDisplayOption.press","Options.hx",511,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_519_updateDisplay,"NPSDisplayOption","updateDisplay",0xf172f391,"NPSDisplayOption.updateDisplay","Options.hx",519,0x9d9a0240)

void NPSDisplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_505_new)
HXLINE( 506)		super::__construct();
HXLINE( 507)		this->description = desc;
            	}
...
bool NPSDisplayOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_511_press)
HXLINE( 512)		::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 513)		this->display = this->updateDisplay();
HXLINE( 514)		return true;
            	}


::String NPSDisplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_519_updateDisplay)
HXDLIN( 519)		::String _hx_tmp;
HXDLIN( 519)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) ))) {
HXDLIN( 519)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 519)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 519)		return (HX_("NPS Display ",ed,73,73,03) + _hx_tmp);
            	}
