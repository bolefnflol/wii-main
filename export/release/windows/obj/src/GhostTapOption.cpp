...
HX_DEFINE_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_123_new,"GhostTapOption","new",0x6c686a7b,"GhostTapOption.new","Options.hx",123,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_129_press,"GhostTapOption","press",0xd68bea5e,"GhostTapOption.press","Options.hx",129,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_137_updateDisplay,"GhostTapOption","updateDisplay",0xb7c6f914,"GhostTapOption.updateDisplay","Options.hx",137,0x9d9a0240)

void GhostTapOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_123_new)
HXLINE( 124)		super::__construct();
HXLINE( 125)		this->description = desc;
            	}
...
bool GhostTapOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_129_press)
HXLINE( 130)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghost",4f,8f,58,93),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 131)		this->display = this->updateDisplay();
HXLINE( 132)		return true;
            	}


::String GhostTapOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_137_updateDisplay)
HXDLIN( 137)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )) {
HXDLIN( 137)			return HX_("Ghost Tapping",44,6c,9f,40);
            		}
            		else {
HXDLIN( 137)			return HX_("No Ghost Tapping",45,a4,10,e0);
            		}
