...
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_51_readByte,"haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",51,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_64_readBytes,"haxe.io.Input","readBytes",0xdda6a671,"haxe.io.Input.readBytes","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",64,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_92_close,"haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",92,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_133_readFullBytes,"haxe.io.Input","readFullBytes",0x3db9a162,"haxe.io.Input.readFullBytes","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",133,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_145_read,"haxe.io.Input","read",0x27b9839a,"haxe.io.Input.read","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",145,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_176_readLine,"haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",176,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_229_readInt16,"haxe.io.Input","readInt16",0xde2f2f9a,"haxe.io.Input.readInt16","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",229,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_243_readUInt16,"haxe.io.Input","readUInt16",0x05cae019,"haxe.io.Input.readUInt16","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",243,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_281_readInt32,"haxe.io.Input","readInt32",0xde2f3154,"haxe.io.Input.readInt32","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",281,0xaf671aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_9ffe530516a82d12_304_readString,"haxe.io.Input","readString",0xfdebd00b,"haxe.io.Input.readString","E:\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",304,0xaf671aeb)
namespace haxe{
namespace io{
...
int Input_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_9ffe530516a82d12_51_readByte)
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_64_readBytes)
HXLINE(  65)		int k = len;
...
void Input_obj::close(){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_92_close)
            	}
...
void Input_obj::readFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_133_readFullBytes)
...
HX_DEFINE_DYNAMIC_FUNC3(Input_obj,readFullBytes,(void))
 ...
 ::haxe::io::Bytes Input_obj::read(int nbytes){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_145_read)
...
::String Input_obj::readLine(){
            	HX_GC_STACKFRAME(&_hx_pos_9ffe530516a82d12_176_readLine)
...
int Input_obj::readInt16(){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_229_readInt16)
...
int Input_obj::readUInt16(){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_243_readUInt16)
...
int Input_obj::readInt32(){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_281_readInt32)
...
::String Input_obj::readString(int len, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_9ffe530516a82d12_304_readString)
