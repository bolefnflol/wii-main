...
HX_DEFINE_STACK_FRAME(_hx_pos_bd3c33ffb64add69_35_new,"haxe.iterators.MapKeyValueIterator","new",0x902a97fd,"haxe.iterators.MapKeyValueIterator.new","E:\\HaxeToolKit\\haxe\\std/haxe/iterators/MapKeyValueIterator.hx",35,0x0741bb7e)
HX_LOCAL_STACK_FRAME(_hx_pos_bd3c33ffb64add69_44_hasNext,"haxe.iterators.MapKeyValueIterator","hasNext",0x6e75ff8a,"haxe.iterators.MapKeyValueIterator.hasNext","E:\\HaxeToolKit\\haxe\\std/haxe/iterators/MapKeyValueIterator.hx",44,0x0741bb7e)
HX_LOCAL_STACK_FRAME(_hx_pos_bd3c33ffb64add69_50_next,"haxe.iterators.MapKeyValueIterator","next",0x951a66b6,"haxe.iterators.MapKeyValueIterator.next","E:\\HaxeToolKit\\haxe\\std/haxe/iterators/MapKeyValueIterator.hx",50,0x0741bb7e)
namespace haxe{
namespace iterators{

void MapKeyValueIterator_obj::__construct(::Dynamic map){
            	HX_STACKFRAME(&_hx_pos_bd3c33ffb64add69_35_new)
...
bool MapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_bd3c33ffb64add69_44_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(MapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic MapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_bd3c33ffb64add69_50_next)
