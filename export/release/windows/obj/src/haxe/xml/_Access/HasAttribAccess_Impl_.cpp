...
HX_LOCAL_STACK_FRAME(_hx_pos_825cde6314a0bbec_59_resolve,"haxe.xml._Access.HasAttribAccess_Impl_","resolve",0x7da9559c,"haxe.xml._Access.HasAttribAccess_Impl_.resolve","E:\\HaxeToolKit\\haxe\\std/haxe/xml/Access.hx",59,0x45a35cd0)
namespace haxe{
namespace xml{
namespace _Access{
...
bool HasAttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_825cde6314a0bbec_59_resolve)
