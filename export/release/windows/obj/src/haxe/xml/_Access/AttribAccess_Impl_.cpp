...
HX_LOCAL_STACK_FRAME(_hx_pos_fd2dc45d10418418_39_resolve,"haxe.xml._Access.AttribAccess_Impl_","resolve",0xf06df4f6,"haxe.xml._Access.AttribAccess_Impl_.resolve","E:\\HaxeToolKit\\haxe\\std/haxe/xml/Access.hx",39,0x45a35cd0)
namespace haxe{
namespace xml{
namespace _Access{
...
::String AttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_fd2dc45d10418418_39_resolve)
