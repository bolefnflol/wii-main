...
HX_LOCAL_STACK_FRAME(_hx_pos_2187afc93813cb58_75_resolve,"haxe.xml._Access.NodeListAccess_Impl_","resolve",0x07a0eeac,"haxe.xml._Access.NodeListAccess_Impl_.resolve","E:\\HaxeToolKit\\haxe\\std/haxe/xml/Access.hx",75,0x45a35cd0)
namespace haxe{
namespace xml{
namespace _Access{
...
::Array< ::Dynamic> NodeListAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_2187afc93813cb58_75_resolve)
