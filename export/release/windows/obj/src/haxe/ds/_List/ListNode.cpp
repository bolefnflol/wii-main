...
HX_DEFINE_STACK_FRAME(_hx_pos_c912014de644d77e_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","E:\\HaxeToolKit\\haxe\\std/haxe/ds/List.hx",266,0x9b85b3b2)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_c912014de644d77e_266_new)
