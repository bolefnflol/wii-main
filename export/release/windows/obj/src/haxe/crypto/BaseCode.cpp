...
HX_DEFINE_STACK_FRAME(_hx_pos_31195a87d03a57a0_33_new,"haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/BaseCode.hx",33,0x7cd468e4)
HX_LOCAL_STACK_FRAME(_hx_pos_31195a87d03a57a0_44_encodeBytes,"haxe.crypto.BaseCode","encodeBytes",0x58a8e40a,"haxe.crypto.BaseCode.encodeBytes","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/BaseCode.hx",44,0x7cd468e4)
HX_LOCAL_STACK_FRAME(_hx_pos_31195a87d03a57a0_72_initTable,"haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/BaseCode.hx",72,0x7cd468e4)
HX_LOCAL_STACK_FRAME(_hx_pos_31195a87d03a57a0_81_decodeBytes,"haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/BaseCode.hx",81,0x7cd468e4)
namespace haxe{
namespace crypto{

void BaseCode_obj::__construct( ::haxe::io::Bytes base){
            	HX_STACKFRAME(&_hx_pos_31195a87d03a57a0_33_new)
...
bool BaseCode_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BaseCode_obj::encodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_31195a87d03a57a0_44_encodeBytes)
...
void BaseCode_obj::initTable(){
            	HX_STACKFRAME(&_hx_pos_31195a87d03a57a0_72_initTable)
...
HX_DEFINE_DYNAMIC_FUNC0(BaseCode_obj,initTable,(void))
 ...
 ::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_31195a87d03a57a0_81_decodeBytes)
