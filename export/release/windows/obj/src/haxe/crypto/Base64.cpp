...
HX_LOCAL_STACK_FRAME(_hx_pos_daeaab5be55c15eb_35_encode,"haxe.crypto.Base64","encode",0xc6961450,"haxe.crypto.Base64.encode","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/Base64.hx",35,0x64a918d3)
HX_LOCAL_STACK_FRAME(_hx_pos_daeaab5be55c15eb_48_decode,"haxe.crypto.Base64","decode",0x319f7f68,"haxe.crypto.Base64.decode","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/Base64.hx",48,0x64a918d3)
HX_LOCAL_STACK_FRAME(_hx_pos_daeaab5be55c15eb_29_boot,"haxe.crypto.Base64","boot",0x49b2c3ec,"haxe.crypto.Base64.boot","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/Base64.hx",29,0x64a918d3)
HX_LOCAL_STACK_FRAME(_hx_pos_daeaab5be55c15eb_30_boot,"haxe.crypto.Base64","boot",0x49b2c3ec,"haxe.crypto.Base64.boot","E:\\HaxeToolKit\\haxe\\std/haxe/crypto/Base64.hx",30,0x64a918d3)
namespace haxe{
namespace crypto{
...
::String Base64_obj::encode( ::haxe::io::Bytes bytes,::hx::Null< bool >  __o_complement){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_daeaab5be55c15eb_35_encode)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Base64_obj,encode,return )
 ...
 ::haxe::io::Bytes Base64_obj::decode(::String str,::hx::Null< bool >  __o_complement){
            		bool complement = __o_complement.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_daeaab5be55c15eb_48_decode)
