...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String luaImage(::String key,::String library);
		static ::Dynamic luaImage_dyn();
		...
		static ::String soundRandomMusic(::String key,int min,int max,::String library);
		static ::Dynamic soundRandomMusic_dyn();
		...
		static ::String voicesEduardo(::String song);
		static ::Dynamic voicesEduardo_dyn();

		static ::String voicesPico(::String song);
		static ::Dynamic voicesPico_dyn();

		static ::String voicesSpooky(::String song);
		static ::Dynamic voicesSpooky_dyn();
