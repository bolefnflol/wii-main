...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Funkin' On A Wii", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Funkin' On A Wii", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "bolefnf";
		app.meta["file"] = "Funkin' On A Wii";
		app.meta["name"] = "Funkin' On A Wii (Mod Owned By B.O.L.E)";
		app.meta["packageName"] = "com.bolefnf.funkinonawii";
		app.meta["version"] = "0.1";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Funkin' On A Wii (Mod Owned By B.O.L.E)",
			width: 1280,
			x: null,
			y: null,
		};
