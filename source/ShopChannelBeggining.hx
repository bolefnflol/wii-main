...
class ShopChannelBeggining extends MusicBeatState
{
	var shop:FlxSprite;
	...
	override public function create()
	{
		...
		shop = new FlxSprite(0, -40).loadGraphic(Paths.image('channels/wiishop/wiishop'));
		add(shop);
		...
		FlxG.sound.playMusic(Paths.music('WiiShopBanner'), 1, true);
