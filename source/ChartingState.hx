...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = ['bf', 'bfMarioHat', 'wii', 'picoLuigiHat', 'spookyWaluigiWarioHat', 'eduardo', 'matt', 'oswald', 'mickey', '3-0'];
		var gfVersions:Array<String> = ['gf', 'gf-crown'];
		var stages:Array<String> = ['stage', 'wii'];
		var noteStyles:Array<String> = ['normal', 'pixel'];
	...
	function updateHeads():Void
	{
		...
		{
			leftIcon.animation.play('alive');
			rightIcon.animation.play('dead');
		}
		else
		{
			leftIcon.animation.play('dead');
			rightIcon.animation.play('alive');
		}
	}
